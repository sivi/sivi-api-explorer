...
const BrandArchiveForm = ({ onSubmit, initialData }) => {
  ...
  return (
    <form onSubmit={handleSubmit} className="design-form">
      <h3 className="form-section-title">Archive Brand</h3>
      <p className="form-hint">
        Archive a brand from your workspace.
      </p>
...
export default BrandArchiveForm;
